...
export default async function middleware(request: NextRequest) {
  ...
  if (pathnameHasLocale) {
    ...
    if (routing.locales.includes(extractedLocale as "ar" | "en")) {
  ...
  // Return supabase response to ensure cookies are properly set
  // Copy locale headers from intl response if needed
